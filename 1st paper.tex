...
\begin{figure}
  ...
  \caption{The probability that a given minimum has $V > 0$ as a function of $\gamma$, for $N=3, 6, 9$. We see that both the heuristics are obeyed: the probability decreases with $N$, and  $\gamma$. \re{should we redo these as eps files?; this looks a bit "fuzzy"?}}
  \label{N6}
  \end{figure}
