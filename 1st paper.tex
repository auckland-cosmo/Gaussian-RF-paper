...
\end{align}
%
\SH{I corrected what i think was a typo in definition of $x_n$. please check.} \lfl{This looks bugged, the second line should be $x_n = -\frac{1}{\sigma_2}\sum_{i=1}^{n-1}\left(\zeta_{ii}-(n-1)x_{1}\right),\,\, (2\leq n \leq N) \,$, although I prefer the original listing all of them explicitly. It's less compact, but more immediately obvious what the pattern is.}
