...
\begin{figure} 
  ...
  \caption{Contour plot of the relative error in $\rm{Log}(P(\Lambda>0|\gamma,N)$ obtained from calculating $P$ using the Gaussian approximation versus the exact numerical result. The trend for increasing $N$ is for the relative error to \emph{decrease}.\SH{need bigger labels on axes and legend}}
  \label{errcontour}
\end{figure}
