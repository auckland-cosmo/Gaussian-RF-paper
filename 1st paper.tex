...
An analysis of the properties of $N$ dimensional Gaussian random functions  thus sets baseline expectations for landscape cosmologies, even if the terms contributing to the landscape at each point are not necessarily uncorrelated in a ``real'' landscape. Moreover, while the complexity of landscape cosmologies is often portrayed as a consequence of their dimensionality, this approach actually obtains traction by focusing on properties of candidate landscapes which become better defined as $N$ increases. 
